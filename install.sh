...
install_packages() {
    ...
    yay -S --noconfirm kitty wofi hyprshot swaync nemo hyprpaper playerctl getnf rofi hyprlock wl-clipboard clipman zed visual-studio-code-bin pavucontrol easyeffects spotify orchis-theme-git nwg-look swaync
